...
function CategoryProduct() {
    ...
    return (
        <div className="container" style={{ padding: '0px' }}>
            <h3 style={{ fontStyle: 'italic', fontSize: '2rem' , color: '#BBBBBB', paddingTop: '60px' }}>MADE THE HARD WAY</h3>
            <h3 style={{  fontStyle: 'italic', fontSize: '3rem', paddingBottom: '15px' }}>TOP TRENDING PRODUCTS</h3>
            {
                data ? data.map((item) => {
